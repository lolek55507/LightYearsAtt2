...
namespace ly {
	PlayerSpaceship::PlayerSpaceship(World* owniningWorld, const std::string& path)
		: SpaceShip{owniningWorld, path}, mMoveInput{}, mSpeed{200.f}, mShooter{ new BulletShooter{this, 0.2f} }
	{
		SetTeamID(1);
	}
